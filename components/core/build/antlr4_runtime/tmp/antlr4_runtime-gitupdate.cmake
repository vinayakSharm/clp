...
execute_process(
  COMMAND "/usr/bin/git" show-ref 4.11.1
  WORKING_DIRECTORY "/mnt/clp/build/antlr4_runtime/src/antlr4_runtime"
...
if("${show_ref_output}" MATCHES "refs/remotes/4.11.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "4.11.1")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 4.11.1
  WORKING_DIRECTORY "/mnt/clp/build/antlr4_runtime/src/antlr4_runtime"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/clp/build/antlr4_runtime/src/antlr4_runtime/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/clp/build/antlr4_runtime/src/antlr4_runtime/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
